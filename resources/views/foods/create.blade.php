    ...
    <div class="row col-md-10">
        ...
        <form method="post" action="{{route('food.store')}}">
            ...
            <div class="form-group " id="food_form_input_fields">
                ...
                <div class="form-group col-md-4 pl-0 float-none ">
                    <label for="sell_price">Food price</label>
                    <input type="text" id="sell_price" name="sell_price" class="form-control"
                           value="{{ old('sell_price') }}"
                           placeholder="Food sell price"
                           required>
                </div>
                <div class="form-group col-md-3 float-left pl-0 pr-0 pb-0">
                    <label for="product_name">Product name</label>
                </div>
                <div class="form-group col-md-1 float-left pl-0 pr-0">
                ...
                <div class="form-group col-md-2 float-left pl-0 pr-0">
                    <label for="total_unit_price">Total price</label>
                </div>
                <div class="form-group col-md-2 float-left pl-0 pr-0">
                ...
                <div class="col-md-12 d-bloc pl-0" id="row">
                    <div class="col-md-3 float-left pl-0 pr-3">
                    ...
                    <div class="col-md-1 float-left pl-0 pr-3">
                        <input type="text" class="form-control" id="unit_1" disabled value="">
                    </div>
                    <div class="col-md-2 float-left pl-0 pr-3">
                        <input type="text" class="form-control" id="unit_price_1" disabled value="">
                    </div>
                    <div class="col-md-2 float-left pl-0 pr-3">
                        <input type="text" class="form-control" id="total_unit_price_1" disabled value="">
                    </div>
        ...
        $('body').on('click', '#add', function () {
            ...
            $('#food_form_input_fields').append(
                '<div class="col-md-12 d-inline-block pl-0" id="row' + i + '">' +
                    '<div class="form-group col-md-3 float-left pr-3 pl-0">' +
                        ...
                        '</select>' +
                        '</div>' +
                            '<div class="form-group col-md-1 float-left pl-0 pr-3">' +
            ...
            $("#row" + (i - 1) + "> div:nth-child(6)").remove();
            ...
            $('#product_1').change(function () {
                let first_product = $('#product_1').children("option:selected").text();
                console.log(products);

                $('#unit_1').attr('value', first_product);
            });
